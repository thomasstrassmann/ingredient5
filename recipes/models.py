...
CUISINE = ((0, "Unassignable"), (1, "European"), (2, "Asian"),
           (3, "Arabic"), (4, "African"), (5, "North-/Southamerican"))
...
class Recipe(models.Model):
    ...
    type = models.IntegerField(choices=CUISINE, null=False,
                               blank=False, default=0)
    content = models.TextField()
    ingredients = models.TextField(blank=True)
    vegetarian = models.BooleanField(default=False)
    status = models.IntegerField(choices=PUBLISHED_STATUS, default=0)
    bookmarks = models.ManyToManyField(User, related_name="recipe_bookmarks",
                                       blank=True)
